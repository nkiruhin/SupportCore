...
namespace SupportCore.Migrations
{
    ...
    [Migration("20181129072559_SLA_1")]
    partial class SLA_1
    {
            ...
            modelBuilder.Entity("SupportCore.Models.Configuration", b =>
                {
                    ...
                    b.HasData(
                        new { Name = "Signature", Section = "email", Title = "Подпись", Type = "html", Value = "С Уважением служба технической поддержки" },
                        new { Name = "FromAddress", Section = "email", Title = "Адресс отправителя", Type = "text", Value = "" },
                        new { Name = "FromName", Section = "email", Title = "От кого", Type = "text", Value = "" },
                        new { Name = "UserId", Section = "email", Title = "Имя пользователя", Type = "text", Value = "" },
                        new { Name = "UserPassword", Section = "email", Title = "Пароль", Type = "password", Value = "" }
                    );
                });
            ...
            modelBuilder.Entity("SupportCore.Models.SLA", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, IsDefault = 1, Name = "Базовый SLA", ResponseTime = 48, Type = 0 }
                    );
                });
